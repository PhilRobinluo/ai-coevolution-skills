...
- [ ] 原创 `SKILL.md`、references、README/docs 和原创 assets 标为 `CC-BY-NC-SA-4.0`；含 `scripts/` 的原创 Skill 在 `registry.json` 标出 `code_license: PolyForm-Noncommercial-1.0.0`，不写入 SKILL 顶层。
