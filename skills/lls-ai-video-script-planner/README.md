...
- 飞书教程：https://m2wlgni9k4.feishu.cn/wiki/QCGNwKqLtiQ10Ak6mZKcoTLGnDg
- SkillHub：https://skillhub.cn/skills/lls-ai-video-script-planner
- Release：https://github.com/PhilRobinluo/ai-coevolution-skills/releases/tag/lls-ai-video-script-planner-v1.1.0

```text
请把这个主题规划成 60 秒视频：先写任务书和节拍表，再给完整分镜、旁白、屏幕文字、素材清单、生成提示和制作验收。
```
...
- **Skill slug：`lls-ai-video-script-planner`**
- **SkillHub 状态：已发布**
...
也可以打开左侧「技能」→「添加技能 / 查找技能」，搜索 `lls-ai-video-script-planner` 后安装；界面文字可能随 WorkBuddy 版本变化。
