...
把反复出现的真实任务提炼成触发准确、流程独特、可测试、可维护的 Skill。

- 当前源码与 Release：`1.1.0`
- [完整用法](SKILL.md)
- [飞书教程](https://m2wlgni9k4.feishu.cn/wiki/QtrVwWBpZilxCHkbFECcvQT0ngP)
- SkillHub：`lls-skill-builder`
- [Release](https://github.com/PhilRobinluo/ai-coevolution-skills/releases/tag/lls-skill-builder-v1.1.0)
