...
先让用户用自己的话复述一次。若复述有误，用一个最小例子纠正，再进入下一步。
...
先只展示题目。用户作答后再给反馈和答案；若用户明确只要完整笔记，可以把答案放进折叠区域。
...
- 📦 [GitHub Release 安装包](https://github.com/PhilRobinluo/ai-coevolution-skills/releases/tag/lls-code-anatomy-v1.0.0)
